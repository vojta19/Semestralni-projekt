...
{
    if(!backgroundMusic.openFromFile("assets/music.ogg")) //primární cesta načtení souboru
    {
        if(!backgroundMusic.openFromFile("../assets/music.ogg")) //záložní cesta načtení souboru
        {
    ...
    if(!clickBuffer.loadFromFile("assets/click.wav")) //načtení zvuku cvaknutí
    {
